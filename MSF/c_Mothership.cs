...
namespace MSF
{
    public class CMothership: CGameObject
    {
		...
		public CMothership(string i1):base(i1)
		{
			oImange = Image.FromFile(i1);

			randNum = new Random(rseed);

			gameObject_Position.X = 380;
			gameObject_Position.Y = 70;
			UpdateGameBounds();
		}
